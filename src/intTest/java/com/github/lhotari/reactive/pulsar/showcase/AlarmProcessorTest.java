...
class AlarmProcessorTest {
        ...
        public Response transform(Request request, Response response, FileSource files,
            ...
            try {
                TelemetryEvent telemetryEvent =
                        objectMapper.readValue(request.getBodyAsString(), TelemetryEvent.class);
    ...
    static class CustomConfig {
        ...
        @Bean
        WireMockConfigurationCustomizer optionsCustomizer(WebhookResponseHolder webhookResponseHolder,
    ...
    void shouldDeliverEventWhenValueGoesOverThresholdAndWhenItGoesBackToNormal() throws InterruptedException {
        // given
        stubFor(post(urlEqualTo("/webhook")).willReturn(aResponse().withTransformers(
                WebhookResponseTransformer.WEBHOOK_TRANSFORMER_NAME)));
